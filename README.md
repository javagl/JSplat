...
- Reader/writer libraries:
  ...
  - [`jsplat-io-sog`](./jsplat-io-sog) - [SOG Format](https://developer.playcanvas.com/user-manual/gaussian-splatting/formats/sog/), with a basic reader and an **eperimental** (and slow) writer.
